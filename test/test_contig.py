...
def test_assemble():
    ...
    assertassemblies(assemble(s, [50]*24, None, s, [50]*24, None),
                     Assembly([('confidences 1', ProperList(0, [50]*24, gap=None, trackclass='integer')),
                               ('bases 1', ProperList(0, s, gap='-', trackclass='nucleotide')),
                               ('confidences 2', ProperList(0, [50]*24, gap=None, trackclass='integer')),
                               ('bases 2', ProperList(0, s, gap='-', trackclass='nucleotide')),
                               ('contig', ProperList(0, s, gap='-', trackclass='nucleotide'))]))

    assertassemblies(assemble("CC"+s, [50]*26, None, s, [50]*24, None),
                     Assembly([('confidences 1', ProperList(0, [50]*26, gap=None, trackclass='integer')),
                               ('bases 1', ProperList(0, "CC"+s, gap='-', trackclass='nucleotide')),
                               ('confidences 2', ProperList(2, [50]*24, gap=None, trackclass='integer')),
                               ('bases 2', ProperList(2, s, gap='-', trackclass='nucleotide')),
                               ('contig', ProperList(0, "CC"+s, gap='-', trackclass='nucleotide'))]))

    assertassemblies(assemble('CCATG'+s, [5,5]+([50]*27), None, s+"TTTTT", [50]*25 + [5]*4, None), 
                     Assembly([('confidences 1',
                                ProperList(0, [5,5]+[50]*27, gap=None, trackclass='integer',
                                           features=[ProperInterval(NegInf(), 2, 
                                                                    blue=0, alpha=0.5, green=0, 
                                                                    name='leftunused', red=0)])),
                               ('bases 1', 
                                ProperList(0, 'CCATG'+s, gap='-', trackclass='nucleotide',
                                           features=[ProperInterval(NegInf(), 2,
                                                                    blue=0, alpha=0.5, green=0,
                                                                    name='leftunused', red=0)])),
                               ('confidences 2', 
                                ProperList(5, [50]*25 + [5]*4, gap=None, trackclass='integer',
                                           features=[ProperInterval(30, PosInf(), 
                                                                    blue=0, alpha=0.5, green=0, 
                                                                    name='rightunused', red=0)])),
                               ('bases 2', 
                                ProperList(5, s+'T'*5, gap='-', trackclass='nucleotide',
                                           features=[ProperInterval(30, PosInf(), 
                                                                    blue=0, alpha=0.5, green=0,
                                                                    name='rightunused', red=0)])),
    ...
    expecteda = \
        Assembly([('confidences 2', ProperList(0, [5]*24, gap=None, trackclass='integer',
    ...
    assertassemblies(assemble(s, [5]*24, None, s, [5]*24, None), 
                     Assembly([('confidences 1', 
                                ProperList(0,[5]*24, gap=None, trackclass='integer',
                               ...
                               ('confidences 2', ProperList(0,[5]*24, gap=None, trackclass='integer',
                                                            features=[ProperInterval(NegInf(), PosInf(), blue=0, 
                                                                                     alpha=0.5, green=0,
                                                                                     name='unused', red=0)])),
                               ('bases 2', ProperList(0,s, gap='-', trackclass='nucleotide',
